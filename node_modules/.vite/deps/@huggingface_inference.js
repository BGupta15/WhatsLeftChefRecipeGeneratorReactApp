...
var ZaiTextToImageTask = class extends TaskProviderHelper {
  constructor() {
    super("zai-org", ZAI_API_BASE_URL);
  }
  prepareHeaders(params, binary) {
  ...
  async getResponse(response, url, headers, outputType) {
    ...
    for (let attempt = 0; attempt < MAX_POLL_ATTEMPTS; attempt++) {
      ...
      if (result.task_status === "SUCCESS") {
        if (!result.image_result || !Array.isArray(result.image_result) || result.image_result.length === 0 || typeof result.image_result[0]?.url !== "string" || !isUrl(result.image_result[0].url)) {
